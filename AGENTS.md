...
An AI-powered personal assistant (product name: **Coriven**) — task management, reminders, and Codex-powered chat with tool use.
...
- **AI:** Anthropic Codex API with tool use
